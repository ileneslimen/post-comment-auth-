...
function AddTache() {
  ...
  const [piece_joint,setPiece]=useState("");
    return (
      ...
      noValidate
      autoComplete="off"
      style={{display:"flex",flexDirection:"column",marginTop:"50px",padding:"30px",boxShadow: "12px 12px 12px 12px rgba(56, 56, 56, 0.08)",width:"300px",marginLeft:"580px"}}
    >
      ...
      <TextField id="standard-basic" label="date_fin" variant="standard" onChange={(e)=>setdate(e.target.value)} value={date_fin} />
      ...
      <Button variant="contained" style={{width:"200px",marginLeft:"10px"}} onClick={()=>dispatch(addtache({titre,description,date_fin,prop,priori,etat,piece_joint},Navigate))}>Add Tache</Button>
    </Box>
